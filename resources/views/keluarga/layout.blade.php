...
<div class="bottom-nav">
    <div class="nav-inner">
        ...
        <a href="{{ route('keluarga.dashboard') }}"
           class="nav-item {{ request()->routeIs('keluarga.dashboard') ? 'active' : '' }}">
            <span class="nav-icon icon-home"></span><br>Home
        </a>

        <a href="{{ route('keluarga.notifikasi') }}"
           class="nav-item {{ request()->routeIs('keluarga.notifikasi') ? 'active' : '' }}">
            <span class="nav-icon icon-bell"></span><br>Notifikasi
        </a>

        <a href="{{ route('keluarga.profil') }}"
           class="nav-item {{ request()->routeIs('keluarga.profil') ? 'active' : '' }}">
...
<script>
    ...
    // push-notification.js will auto-subscribe if permission granted
</script>
